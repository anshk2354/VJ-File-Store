# Don't Remove Credit Tg - @mxmoder
# Subscribe YouTube Channel For Amazing Bot https://youtube.com/@mxmoder
# Ask Doubt on telegram @Moviemxmoder_bot
...
async def start(client, message):
    ...
    if len(message.command) != 2:
        buttons = [[
            InlineKeyboardButton('💝 𝐌𝐨𝐯𝐢𝐞 𝐜𝐡𝐚𝐧𝐧𝐞𝐥', url='https://t.me/hd_telegram_movies')
            ],[
...
# Ask Doubt on telegram @Moviemxmoder_bot
    ...
    if not files_:
        ...
        try:
            ...
            title = '@Moviemxmoder_bot  ' + ' '.join(filter(lambda x: not x.startswith('[') and not x.startswith('@'), file.file_name.split()))
...
# Don't Remove Credit Tg - @Moviemxmoder_bot
# Subscribe YouTube Channel For Amazing Bot https://youtube.com/@mxmoder
# Ask Doubt on telegram @Moviemxmoder_bot
...
async def cb_handler(client: Client, query: CallbackQuery):
    if query.data == "close_data":
        ...
        buttons = [[
            InlineKeyboardButton('💝 𝐌𝐨𝐯𝐢𝐞 𝐜𝐡𝐚𝐧𝐧𝐞𝐥 ', url='https://youtube.com/@mxmoder')
            ],[
            InlineKeyboardButton('🤖 ᴄʀᴇᴀᴛᴇ ʏᴏᴜʀ ᴏᴡɴ ᴄʟᴏɴᴇ ʙᴏᴛ', url=f'https://t.me/{BOT_USERNAME}?start=clone')
            ],[
            InlineKeyboardButton('💁‍♀️ ʜᴇʟᴘ', callback_data='help'),

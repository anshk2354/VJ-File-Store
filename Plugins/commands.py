...
# Ask Doubt on telegram @mxmoder_bot
...
async def start(client, message):
    ...
    if len(message.command) != 2:
        buttons = [[
            ...
            InlineKeyboardButton('🔍 sᴜᴘᴘᴏʀᴛ ɢʀᴏᴜᴘ', url='https://t.me/+Az_CHIVozrVjMWI1'),
            InlineKeyboardButton('🤖 ᴜᴘᴅᴀᴛᴇ ᴄʜᴀɴɴᴇʟ', url='https://t.me/mxmoder')
            ],[
...
# Ask Doubt on telegram @mxmoder_bot
    ...
    if not files_:
        ...
        try:
            ...
            title = '@mxmoder_bot  ' + ' '.join(filter(lambda x: not x.startswith('[') and not x.startswith('@'), file.file_name.split()))
